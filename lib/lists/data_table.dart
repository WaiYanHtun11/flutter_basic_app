...
const kTableColumns = <DataColumn>[
  ...
  DataColumn(label: Text("Subject"),tooltip: "Student's Enrolled subjects"),
...
class StudentDataSource extends DataTableSource{
  ...
  final List<Student> _students = <Student>[
    ...
    Student("Student13", 11, "Subject 1","mail1@gmail.com"),
    Student("Student14", 11, "Subject 1","mail1@gmail.com"),
  ];
